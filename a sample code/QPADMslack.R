...
# QPADMslackCPP(y, x, tau, lambda, a, pho, funname, maxstep, eps, intercept). 
...
QPADMslack_scad = QPADMslackCPP(Y, X, 0.7, 15, 3.7, 5, "scad", 500, 1e-03, FALSE)
beta = QPADMslack_scad[1:p]
